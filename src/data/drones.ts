...
export const DRONES: Drone[] = [
  {
    ...
    summary:
      "A low-signature quadcopter built for first-look reconnaissance. Dual EO/IR optics, encrypted downlink, and a light undercarriage bay for modular mission kits.",
    price: 289,
    priceLabel: "$289",
  ...
  },
  {
    ...
    summary:
      "Helicopter platform for long-dwell observation. Multi-lens nose gimbal, carbon boom, and a mid-class payload bay sized for heavier ISR packages.",
    price: 790,
    priceLabel: "$790",
  ...
  },
  {
    ...
    summary:
      "Aggressive multi-rotor built for heavier mission kits. Dual lateral hardpoints, high-output propulsion, and a reinforced bay for strike-simulation payloads in the STRAFE network.",
    price: 1490,
    priceLabel: "$1,490",
